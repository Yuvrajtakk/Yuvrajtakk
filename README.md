...
[![Portfolio](https://img.shields.io/badge/PORTFOLIO-projects--ruby--five.vercel.app-ff4d1c?style=for-the-badge&logo=vercel&logoColor=white)](https://projects-ruby-five.vercel.app)
[![LinkedIn](https://img.shields.io/badge/LINKEDIN-Connect-ff6a2e?style=for-the-badge&logo=linkedin&logoColor=white)](#)
[![Gmail](https://img.shields.io/badge/EMAIL-Reach%20out-ff8a1e?style=for-the-badge&logo=gmail&logoColor=white)](#)

</div>

### Current technique

I'm a **B.Tech CSE-AI** student (batch 2023–2027, CGPA 8.5) at Anand International College of Engineering, Jaipur, currently running a remote **AI/ML internship at Watsoo Express Pvt. Ltd.** under Ankit Gupta.

```
short-term cursed technique : ML  →  Deep Learning  →  applied AI
long-term domain expansion  : AI × interactive / game systems
```

Right now that means building from-scratch ML implementations, benchmarking them against real datasets, and documenting the process like a lab notebook rather than a one-off notebook dump. The game-dev side (Unity, C#) runs in parallel as the second track that eventually merges with the AI one — intelligent, reactive interactive systems are the long-term target, not a side hobby.
...
**🔢 [mnist-digit-recognizer](https://github.com/Yuvrajtakk/mnist-digit-recognizer)**

MNIST digit recognition comparing 7 ML algorithms head-to-head — Linear Regression, Logistic Regression, KNN, Decision Tree, Random Forest, Naive Bayes, and SVM. SVM came out on top at **98.15% accuracy**. Built during the Watsoo Express internship, fully documented with a results comparison table.
...
**📓 [ml-internship](https://github.com/Yuvrajtakk/ml-internship)**

The learning-phase codebook — 9 structured Python files walking through ML algorithms from foundational concepts through evaluation metrics, themed around a Watsoo Express truck-health use case. The reference repo the MNIST comparison was built on top of.
...
![Python](https://img.shields.io/badge/-Python-14151a?style=flat-square&logo=python&logoColor=ff8a1e)
...
![C#](https://img.shields.io/badge/-C%23-14151a?style=flat-square&logo=csharp&logoColor=ff8a1e)
![Git](https://img.shields.io/badge/-Git-14151a?style=flat-square&logo=git&logoColor=ff8a1e)
![VS Code](https://img.shields.io/badge/-VS%20Code-14151a?style=flat-square&logo=visualstudiocode&logoColor=ff8a1e)
...
<sub>the flame holds as long as the streak does.</sub>
